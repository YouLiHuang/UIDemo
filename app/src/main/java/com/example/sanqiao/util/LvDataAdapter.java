...
public class LvDataAdapter extends BaseAdapter {
    ...
    private List<oneGroupInfo> weldingList;    // 用户信息数据集合

    public LvDataAdapter(Context context, List<oneGroupInfo> weldingList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        // 这里进行数据填充
        oneGroupInfo item = weldingList.get(position);
